...
- Supported Algos (default 0.5% dev fee):
    ...
    - Alephium (AMD, Nvidia)
    - Kaspa (AMD, Nvidia, 1% dev fee, +1% (optional) community fund (can be ENABLED with disable_community_fund option, disabled by DEFAULT))
    - Radiant (AMD, Nvidia, 1% dev fee, +1% (optional) community fund (can be ENABLED with disable_community_fund option, disabled by DEFAULT))
    ...
    - Meowcoin (AMD, Nvidia)
    - Nexa (Nvidia, 2% dev fee, +1% (optional) community fund (can be ENABLED with disable_community_fund option, disabled by DEFAULT))
